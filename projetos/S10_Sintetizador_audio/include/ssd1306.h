...
extern void ssd1306_draw_rect(uint8_t *ssd, uint8_t x_start, uint8_t y_start, uint8_t x_end, uint8_t y_end,bool mode);
extern void ssd1306_fill_rect(uint8_t *ssd, uint8_t x_start, uint8_t y_start, uint8_t x_end, uint8_t y_end,bool mode);
