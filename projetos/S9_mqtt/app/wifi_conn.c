#include "include/wifi_conn.h" // cabeçalho com a função de conexão Wi-Fi​

/**​
* Função: connect_to_wifi​
* Objetivo: Inicializar o chip Wi-Fi da Pico W e conectar a uma rede
usando SSID e senha fornecidos.​
*/
